...
void RDDLTask::print(std::ostream& out) {
    ...
    *///Alex : end
	...
	/*
        out << "## kleene caching type" << std::endl;
				...
				//Murugeswari
				CPFs[index]->kleeneCachingType = "NONE";
	...
	*///Alex : end
    ...
    out << "## kleene caching type" << std::endl;
		...
		//Murugeswari
		rewardCPF->kleeneCachingType = "NONE";
    ...
    *///Alex : end
    ...
    for (unsigned int index = 0; index < actionPreconds.size(); ++index) {
        ...
        out << "## caching type" << std::endl;
				...
				//Murugeswari
				actionPreconds[index]->cachingType = "NONE";
	...
	/*
        out << "## kleene caching type" << std::endl;
				...
				//Murugeswari
				actionPreconds[index]->kleeneCachingType = "NONE";
	...
	*///Alex : end
	...
	/*
        out << "## kleene state fluent hash keys (first line is the number of "
            ...
            << std::endl;
				//Murugeswari
				(indexToKleeneStateFluentHashKeyMap[index]).clear();
	...
	*///Alex : end
	...
	/*
        out << "## kleene state fluent hash keys (first line is the number of "
            ...
            << std::endl;
				//Murugeswari
				(indexToKleeneStateFluentHashKeyMap).clear();
...
void RDDLTask::execute(std::string td /*target dir*/) {
    ...
    //Murugeswari - commented out all std::cout's
    t.reset();
